...
$(window).scroll(
	function(){
		$(document).scrollTop()>0?"big"==$("#headerstic").data("size")&&(
			...
			$("#headerstic .logo").stop().animate({width:"175px"},500),
			$("#headerstic").addClass("tiny-nav") ):"small"==$("#headerstic").data("size")&&(
				$("#headerstic").data("size","big"),
				$("#headerstic .logo").stop().animate({width:"175px"},200),
...
jQuery(document).ready(function(){
	jQuery(".banner").revolution({
		...
		hideThumbs:0,
		navigationType:"",navigationArrows:"solo",
