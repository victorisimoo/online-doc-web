materialAdmin
    ...
    .service('formatService', function() {
        return {
            formatDoctorName: function(doctor) {
                var doctorPrefix = doctor.admUser.admPerson.gender === 1 ? "al Dr. " : "a la Dra. ";
                return doctorPrefix 
                        + doctor.admUser.admPerson.firstName.trim() + " "
                        + doctor.admUser.admPerson.lastName.trim();
            },
            formatDoctorNameShort: function(doctor) {
                var doctorPrefix = doctor.admUser.admPerson.gender === 1 ? translationPrefered.DOCTOR_MALE_LABEL : translationPrefered.DOCTOR_FEMALE_LABEL;
                return doctorPrefix + " "
                        + doctor.admUser.admPerson.firstName.trim() + " "
                        + doctor.admUser.admPerson.lastName.trim();
            }
