(function () {
    ...
    function ngGallery($document, $timeout, $q, $templateCache) {
        ...
        $templateCache.put(template_url,
            '  <div ng-repeat="i in images" class="col-sm-4 divPicture">' +
            ' <div class="picDiv" style="background-image: url( '+"'"+'{{i.thumb}}'+"'"+' )" ng-click="openGallery($index)"></div>' +
            '  </div>' +
            '</div>' +
            ...
            '  <span class="info-text2">{{ description }}</span>' +
            '  <span class="info-text3">{{ sendDate }}</span>' +
            '  <div class="ng-thumbnails-wrapper hidden">' +
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                var showImage = function (i) {
                    ...
                    scope.sendDate = scope.images[i].sendDate || '';
                };
