...
Helpers.prototype.getMessageStatus = function(message){
    ...
    var self = this,
        ...
        status = !deleveredToOcuupants ? parent.translationPrefered.GENERAL_SENT :
            readedByOcuupants ? parent.translationPrefered.MESSAGE_SEEN : parent.translationPrefered.MESSAGE_DELIVERED;
