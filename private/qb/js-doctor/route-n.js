...
router.on({
    ...
    '/dialog/:dialogId': function(params){
        ...
        function _renderSelectedDialog(){
            sendMessage(userQBId[dialogId]);
            actualMedicalId = medicalIdList[dialogId];
            ...
            if(!currentDialog){
                ...
                logInfo(actualMedicalId, "DRONLINE DOCTOR: Renderizando histórico de chats.");
                dialogModule.renderMessages(dialogId);
