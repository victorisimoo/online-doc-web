        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <strong><h4>ADVERTENCIA</h4></strong>
                </div>

                <div class="modal-body">
                    <b><p style="text-align: justify;">
                        Se ha detectado un error de lado del paciente, por lo cual, se cerrará la consulta.
                    </p></b>
                </div>
                <div class="modal-footer">
                    <a type="button" class="btn btn-danger col-12 j-accept-error">Aceptar</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/template" id="tpl_default">
        ...
        <script type="text/template" id="tpl_device_not_found">
               ...
               <script type="text/template" id="frames_tpl">
                    ...
                    <div class="col-sm-12 pull-rigth">
                        <div>
                            <h4 class="caller__name">
                                <b>Conectado con:</b>
                                <span id="user-patient">(<%= namePatient %>)</span>
                            </h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12" style="padding-left: 0!important; padding-right: 0 !important;">
                        <div class="frames">
                            <div class="frames__main" style='text-align: center;'>
                                <div class="frames__main_timer hidden" id="timer">
                                </div>

                                <div id="main_video_container" class="qb-video" style="position:fixed; top:0; min-width: 100% !important; width: 100% !important;">
                                    <video controls id="main_video" class="frames__main_v qb-video_source withoutResponse videoResponse" autoplay playsinline></video>
                                </div>
                            </div>

                            <div class="frames__callees j-callees hidden"></div>
                        </div>
                    </div>
                    <div class="col-sm-4" style="position:fixed; width:20%; right: 0; top: 10px">
                        <div class="caller">
                            ...
                            <div class="caller__frames">
                                <div class="qb-video">
                                    <video id="localVideo" class="my-video-source" autoplay playsinline></video>
                                </div>
                                ...
                                <div class="caller__frames_source">
                                    <select class="qb-select j-source" style='display: none;'>
                                    </select>
                                </div>
                            </div>
                        </div>
            ...
            <script type="text/template" id="callee_video">
                <div class="frames_callee callees__callee j-callee" style="width:100% !important;">
