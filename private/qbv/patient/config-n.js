...
(function (window) {
    ...
    infoLog("VALOR de QB: "+qbi);
    var res = JSON.parse(qbi);
    medicalAppointmentId = res.medicalAppointmentId;
    logInfo(medicalAppointmentId, "DRONLINE PATIENT: Se reciben parametros de consulta en el iframe.");
    var currentUser;
    var QBUsers = [{
        id: res.doctor.QBId,
    ...
    const MESSAGES = {
        ...
        'calling': 'Calling...',
        'webrtc_not_avaible': 'WebRTC no esta habilitado en tu navegador, por lo cual, se finalizará la consulta.',
