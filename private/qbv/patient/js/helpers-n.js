                ...
                if(csErr) {
                    ...
                    QB.login(userRequiredParams, function(loginErr, loginUser){
                        if(loginErr) {
                            ...
                            logSevere(medicalAppointmentId,"Error en QB.chat.connect - login: "+userRequiredParams.login+" - password: "+userRequiredParams.password+" - INFO: "+JSON.stringify(loginErr));
                            sendMessage(2);
                            /*QB.users.create({
                            ...
                            /** Update info */
                            logInfo(medicalAppointmentId,"DRONLINE PATIENT: Login de Quickblox exitoso con el usuario: "+userRequiredParams.login);
