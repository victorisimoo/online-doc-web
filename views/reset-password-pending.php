...
<body class="login-lp">          
            ...
            <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12">                                                   
                <div class="login-content">
                    ...
                    margin-top:10px; max-width:none !important; width:100%;">
                        <p id="restarPassword"><strong>Reinicio de contraseña</strong></p>
                        <div class="lcb-form">
                            <p id = "notif">En breve recibirás un correo con los pasos a seguir para completar el reinicio de tu contraseña. Por favor revisa tu bandeja de correo.</p>
                        </div>
                    </div>
                </div>
    ...
    <?php if ($resource != "") { ?>
            ...
            <script>
                ...
                $("#restarPassword").text(userTranslations.RESTART_PASSWORD);
                $("#notif").text(userTranslations.ALERTS_TITLES_RESET_PASSWORD_EMAIL_SENT);
